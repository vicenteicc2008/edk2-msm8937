...
cat workspace/MSM8909_UEFI.fd.gz device_specific/land.dtb > workspace/land-kernel
./scripts/mkbootimg --kernel=workspace/land-kernel --output=workspace/land.img --cmdline="EDK2" --base=0x80000000