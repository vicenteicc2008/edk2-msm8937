 ...
 *
 * Disassembly of MSM8909Pkg/AcpiTables/SSDT.aml, Mon Apr 27 12:09:55 2026
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000103D (4157)
 *     Revision         0x02
 *     Checksum         0xAA
 *     OEM ID           "MMO   "
 ...
 */
DefinitionBlock ("", "SSDT", 2, "MMO   ", "MSM8909 ", 0x00000003)
{
    ...
    External (_SB_.I2C1.AVBL, IntObj)
    External (_SB_.I2C5, UnknownObj)
    External (_SB_.PEP0, UnknownObj)
    External (_SB_.PEP0.FLD0, FieldUnitObj)

    Scope (\_SB)
    {
        Device (ACC1)
        {
            Name (_HID, "MSHW101A")  // _HID: Hardware ID
            ...
            Scope (\_SB.I2C1)
            {
                OperationRegion (ACC1, GenericSerialBus, Zero, 0x0100)
            }

            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Field (\_SB.I2C1.ACC1, BufferAcc, NoLock, Preserve)
                {
                    Connection (
        ...
        Device (ACC2)
        {
            Name (_HID, "MSHW101B")  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Name (_DEP, Package (One)  // _DEP: Dependencies
            {
                \_SB.I2C1
            ...
            Method (PRIM, 0, NotSerialized)
            {
                ...
                Return (RBUF) /* \_SB_.ACC2.PRIM.RBUF */
            }

            Scope (\_SB.I2C1)
            {
                OperationRegion (ACC2, GenericSerialBus, Zero, 0x0100)
            }

            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Field (\_SB.I2C1.ACC2, BufferAcc, NoLock, Preserve)
                {
                    Connection (
                        I2cSerialBusV2 (0x001E, ControllerInitiated, 0x00061A80,
                            AddressingMode7Bit, "\\_SB.I2C1",
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.ACC2._CRS.RBUF */
            }
            ...
            Method (ROTM, 0, NotSerialized)
            {
                ...
                Return (RBUF) /* \_SB_.ACC2.ROTM.RBUF */
            }
        }
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                ...
                If ((Arg0 == ToUUID ("a2e7f6c4-9638-4485-9f12-6b4e20b60d63") /* Unknown UUID */))
                {
                    ...
                    If ((Arg2 == 0x03))
                    {
                        ...
                        {
                            /* 0000 */  0x53, 0x61, 0x61, 0x6E, 0x61, 0x00, 0x00, 0x00,  // Saana...
                            ...
                            /* 03C0 */  0x0C, 0x48, 0x19, 0x0D, 0x03, 0x00, 0x40, 0x04   // .H....@.
                        })
                    }
                }
            }
        ...
        Device (DISP)
        {
            ...
            Method (PINS, 0, NotSerialized)
            {
                ...
                Return (RBUF) /* \_SB_.DISP.PINS.RBUF */
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.DISP._CRS.RBUF */
            }
            ...
            Method (_PS0, 0, NotSerialized)  // _PS0: Power State 0
            {
                DEID = Buffer (ESNL) {}
                DVAL = Zero
                DEID = PGID /* \_SB_.DISP.PGID */
                If (\_SB.ABD.AVBL)
                {
                    \_SB.PEP0.FLD0 = DBUF /* \_SB_.DISP.DBUF */
                }
            }
